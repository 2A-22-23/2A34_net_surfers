<?php
    ...
    if (isset ($_POST ["id_seance"]) && isset ($_POST ["date"]) && isset ($_POST ["heure"])&& isset ($_POST ["nb_participant"])&& isset ($_POST ["seance"])){
        if (!empty ($_POST ["id_seance"]) && !empty($_POST ["date"]) && !empty($_POST ["heure"]) && !empty($_POST ["nb_participant"])&& !empty($_POST ["seance"])){ 
            ...
            $coachingC->createSeance($coaching);
    ...
    <div class="form"style="width:250% ;position:relative;left: -180px;0px;">
              ...
              <input type="text" name="id_seance" id="id_seance" autocomplete="off" required / >
        ...
        <div class="form"style="width:250% ;position:relative;left: -180px;0px;">
           <input type="text" name="nb_participant" id="nb_participant" class="form" autocomplete="off" required />
        ...
        <div class="form"style="width:250% ;position:relative;left: -180px;0px;">
         ...
         <div class="input_field">
            <input style="background-color:#333333;color:#00FF00;border-radius:5px;position:absolute;left: 670px;px;bottom: 250px;font-size: 40px" type="submit" value="Ajouter" class="button">
         </div>
