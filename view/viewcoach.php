    ...
    <table class="table">
        ...
        <?php foreach ($list as $row){ ?>
            <tr>
                ...
                <td><?=$row["role"]?></td>
                <td><?=$row["mdp"]?></td>    
                <td><a href="updateuser.php?id=<?= $row['id'] ?>"><button class="btn btn-primary" style="height:40px" ><i class="fa fa-edit"></i></button>
                <a href="kounji.php?id=<?= $row['id'] ?>"><button class="btn btn-primary" style="height:40px; margin-left:25px;" ><i class="fa fa-role">K</i></button></a></td></a>
