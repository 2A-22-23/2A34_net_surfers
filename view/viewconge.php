    ...
    <table class="table">
        <thead>
            <tr>
                ...
                <th class="text-center">Id Coach</th>
        ...
        <?php foreach ($list as $row){ ?>
            <tr>
                ...
                <td><?=$row["date_fin"]?></td>     
                <td><a href="updateconge.php?id=<?= $row['id_conge'] ?>"><button class="btn btn-primary" style="height:40px" ><i class="fa fa-edit"></i></button></td></a>
                <td><a href="deleteconge.php?id=<?= $row['id_conge'] ?>"><button class="btn btn-danger" style="height:40px" ><i class="fa fa-remove"></i></button></td></a>
                <?php
                }
                ?>
            </tr>
