...
<?php
    ...
    if (isset ($_POST ["titre"],$_POST ["debut"], $_POST ["fin"], $_POST ["adresse"], $_POST ["num"], $_POST ["organisme"], $_POST ["choix"], $_POST ["montant"]) ){
        if (!empty ($_POST ["titre"]) && !empty ($_POST ["debut"]) && !empty($_POST ["fin"])&& !empty($_POST ["adresse"])&& !empty($_POST ["num"])&& !empty($_POST ["organisme"])&& !empty($_POST ["choix"])&& !empty($_POST ["montant"])){
            $event1 = new event(NULL, $_POST ["titre"], $_POST ["debut"], $_POST ["fin"], $_POST ["adresse"], $_POST ["num"], $_POST ["organisme"], $_POST ["choix"], $_POST ["montant"]);
            $eventC = new eventC();
            $eventC->createEvent($event1);
...
<form action="" method="POST" onsubmit="return validateForm()">
    ...
    <input type="date" name="debut" id="debut" oninput="validateDate()">
    <span id="debut-error" class="error"></span>
    <br>
    <label for="fin"> Date Fin </label>
    <input type="date" name="fin" id="fin" oninput="validateDate()">
    <span id="fin-error" class="error"></span>
    <br>
    <br>
    <label for="adresse"> Adresse </label>
    <input type="text" name="adresse" id="adresse" oninput="validateAdresse()">
    <span id="adresse-error" class="error"></span>
    <br>
    <br>
    <label for="num"> Num </label>
    <input type="number" name="num" id="num" oninput="validateNum()">
    <span id="num-error" class="error"></span>
    <br>
    <br>
    <label for="organisme"> Organisme </label>
    <input type="text" name="organisme" id="organisme" oninput="validateOrganisme()">
    ...
    <input type="number" name="montant" id="montant" oninput="validateMontant()">
